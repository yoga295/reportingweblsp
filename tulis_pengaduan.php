        ...
        <div class = "card-body">
            <form action="simpan_pengaduan.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-group cols-sm-6">
                    ...
                    <textarea class="form-control" cols="7" name="isi_laporan"></textarea>
                </div>
                <div class="form-group cols-sm-6">
                    <label>Upload Foto</label>
                    <input type="file" name="foto" class="form-control" accept=".jpeg, .jpg, .png, .gif"><font color="red">Tipe yang bisa diupload adalah : .jpeg, .jpg, .png, .gif</font>
                </div>
                <div class="form-group cols-sm-6">
